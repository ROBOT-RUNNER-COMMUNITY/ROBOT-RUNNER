...
class AnalyticsWidget(QWidget):
    ...
    def _init_ui(self):
        ...
        # Container for charts with scroll area
        scroll = QScrollArea()
        scroll.setWidgetResizable(True)
        charts_container = QWidget()
        charts_layout = QVBoxLayout(charts_container)
        
        # Time Series Chart - with controlled size
        ...
        self.time_series_canvas.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        self.time_series_canvas.setMinimumHeight(300)
        charts_layout.addWidget(QLabel("Test Execution Trends:"))
        charts_layout.addWidget(self.time_series_canvas)
        
        # Failure Analysis Chart - with controlled size
        ...
        self.failure_canvas.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        self.failure_canvas.setMinimumHeight(300)
        charts_layout.addWidget(QLabel("Failure Analysis:"))
